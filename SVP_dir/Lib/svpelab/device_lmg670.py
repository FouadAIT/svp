...
class Device(object):
    ...
    def pf_sunspec_EEI_convention(self, data):
        ...
        for channel in range(1, self.channels_number + 1):
            if self.channels[channel]['type'] != 'AC':
                continue
            else:
...
if __name__ == "__main__":
    ...
    params['pf_convention'] = 'Sunspec_EEI'
    params['scale_i_inverse'] = True
    params['channels'] = [None, 
                        {'type': 'AC', 'points': ('VRMS', 'IRMS', 'P', 'S', 'Q', 'PF', 'FREQ', 'INC'), 'label': '1', 'ratio': '0.9923'}, 
                        {'type': 'AC', 'points': ('VRMS', 'IRMS', 'P', 'S', 'Q', 'PF', 'FREQ', 'INC'), 'label': '2', 'ratio': '0.9923'}, 
                        {'type': 'AC', 'points': ('VRMS', 'IRMS', 'P', 'S', 'Q', 'PF', 'FREQ', 'INC'), 'label': '3', 'ratio': '0.9923'}, 
                        {'type': 'DC', 'points': ('V', 'I', 'P'), 'label': '4', 'ratio': '1.0002'}, 
                        {'type': 'DC', 'points': ('V', 'I', 'P'), 'label': '5', 'ratio': '1.0002'}, 
                        {'type': 'Unused', 'points': None, 'label': None, 'ratio': '1.0002'}, 
                        {'type': 'Unused', 'points': None, 'label': None, 'ratio': '1.0002'}]
    params['groups'] = ['3,2,1,1', {'wiring': 'Direct'}, {'wiring': 'Direct'}]
    daq = Device(params=params,ts =None)
    print((daq.info()))
    
    print(len(daq.data_read()))
    daq.close()
