<scriptConfig name="LAP_0" script="LAP">
  <params>
    <param name="lap.act_pwr" type="string">0%</param>
    <param name="lap.test_fw_1_tr" type="float">0.5</param>
    <param name="lap.test_vw_1_tr" type="float">0.5</param>
