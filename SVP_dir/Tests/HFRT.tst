<scriptConfig name="HFRT" script="FRT">
  <params>
    ...
    <param name="frt.hf_parameter" type="float">61.8</param>
    ...
    <param name="frt.hf_period" type="float">299.0</param>
    ...
    <param name="frt.lf_ena" type="string">Disabled</param>
    ...
    <param name="frt.hf_ena" type="string">Enabled</param>
