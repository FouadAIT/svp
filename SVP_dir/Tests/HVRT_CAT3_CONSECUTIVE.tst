<scriptConfig name="HVRT_CAT3_CONSECUTIVE" script="VRT">
  <params>
    ...
    <param name="vrt.phase_comb_ab" type="string">Disabled</param>
    <param name="vrt.phase_comb_abc" type="string">Disabled</param>
