<scriptConfig name="LVRT_CAT3_CONSECUTIVE_BC" script="VRT">
  <params>
    ...
    <param name="vrt.two_phase_value_1" type="string">B</param>
    <param name="vrt.two_phase_value_2" type="string">C</param>
    ...
    <param name="das.opal.rms_enable" type="string">Yes</param>
    <param name="das.opal.opwrite_enable" type="string">Yes</param>
