<scriptConfig name="CRP_FIX" script="CRP">
  <params>
    <param name="crp.q_max_abs_value" type="float">-0.8</param>
    <param name="crp.q_max_inj_value" type="float">0.8</param>
    ...
    <param name="crp.imbalance_fix" type="string">fix_ang</param>
  </params>
</scriptConfig>
