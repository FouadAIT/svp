<scriptConfig name="LAP_33" script="LAP">
  <params>
    <param name="lap.iter" type="int">1</param>
    <param name="lap.test_fw_1_tr" type="float">5.0</param>
    <param name="lap.test_vw_1_tr" type="float">5.0</param>
    <param name="lap.act_pwr" type="string">33%</param>
