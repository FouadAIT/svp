<scriptConfig name="LVRT_CAT3_CONSECUTIVE_C" script="VRT">
  <params>
    ...
    <param name="vrt.one_phase_value" type="string">C</param>
    ...
    <param name="vrt.wav_ena" type="string">No</param>
    ...
    <param name="vrt.data_ena" type="string">Yes</param>
