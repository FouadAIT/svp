<scriptConfig name="PRI_WV" script="Prioritization">
  <params>
    <param name="pri.pri_response_time" type="float">0.5</param>
    ...
    <param name="pri.vv_status" type="string">Disabled</param>
    <param name="pri.cpf_status" type="string">Disabled</param>
    <param name="pri.crp_status" type="string">Disabled</param>
